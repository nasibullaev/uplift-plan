...
/**
 * Script to create test orders for Payme integration testing
 * Usage: node create-test-order.js <order_id>
 * Example: node create-test-order.js test_order_19
 */
...
if (!orderId) {
  ...
  console.log("Usage: node create-test-order.js <order_id>");
  console.log("Example: node create-test-order.js test_order_19");
  process.exit(1);
}

// Run the script
createTestOrder(orderId).catch(console.error);
