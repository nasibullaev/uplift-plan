...
/**
 * Script to create test_order_42 with amount 50000 UZS for Payme integration testing
 */
...
async function createTestOrder42() {
  try {
    const orderId = "test_order_42";
...
// Run the script
createTestOrder42().catch(console.error);
