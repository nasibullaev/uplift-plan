...
/**
 * Script to create test_order_36 with amount 50000 UZS for Payme integration testing
 */
...
async function createTestOrder36() {
  try {
    const orderId = "test_order_36";
    const amountUZS = 50000; // 50000 UZS as requested
    const amountTiyin = amountUZS * 100; // Convert to tiyin (1 UZS = 100 tiyin)

    console.log(
      `🚀 Creating test order: ${orderId} with amount ${amountUZS} UZS...`
    );
    ...
    console.log("   - Payment Method: Payme");
    console.log("\n🧪 Test the Payme integration with this order!");
  } catch (error) {
...
// Run the script
createTestOrder36().catch(console.error);
