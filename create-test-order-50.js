...
/**
 * Script to create test_order_50 with amount 50000 UZS for Payme integration testing
 */
...
async function createTestOrder50() {
  try {
    const orderId = "test_order_50";
...
// Run the script
createTestOrder50().catch(console.error);
